...
import com.authenticationservice.exception.CustomAccessDeniedHandler;
import com.authenticationservice.filter.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth // Configure request authorization
                        .requestMatchers("/auth/new", "/auth/authenticate", "/actuator/**", "/auth/**").permitAll() // Publicly
                                                                                                                    // accessible
                                                                                                                    // endpoints
